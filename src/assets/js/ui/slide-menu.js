...
(function (global) {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".mobile-menu-l1:active { background: rgba(46,125,50,.06); }",
      "html.dark .mobile-menu-l1:active { background: rgba(46,125,50,.10); }",
      ".mobile-menu-l1-icon {",
      ...
      "}",
  "html.dark .mobile-menu-l2-item.is-active { color: #4CAF50; }",
      ...
      "  -webkit-tap-highlight-color: transparent;",
      "}",
      ".mobile-search-result-item:active { background: rgba(46,125,50,.06); }",
