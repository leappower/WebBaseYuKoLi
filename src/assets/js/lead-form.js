...
(function () {
  ...
  function createOverlay() {
    ...
    box.innerHTML =
      ...
      '<form id="yk-lead-form" novalidate>' +
        ...
        '<button type="submit" style="width:100%;padding:12px;background:' + BRAND_COLOR + ';' +
  ...
  (function injectStyles() {
    ...
    s.textContent = '@keyframes ykFadeIn{from{opacity:0;transform:translateY(12px)}to{opacity:1;transform:translateY(0)}}';
