...
(function () {
  ...
  function renderWaCard(cfg, device) {
    if (device === "mobile") {
      var _wa = window.Contacts && window.Contacts.whatsapp || ((_cfg.contacts || {}).whatsapp) || "8613924828214";
      return (
        '<a href="https://wa.me/' +
        _wa +
        '"' +
  ...
  function renderPhoneCard(cfg, device) {
    if (device === "mobile") {
      var _tel = window.Contacts && window.Contacts.whatsapp || ((_cfg.contacts || {}).whatsapp) || "8613924828214";
      return (
        '<a href="tel:+' +
        _tel +
