...
const filesToProcess = fs.readFileSync('batch2_files_pc.txt', 'utf8').split('\n').filter(f => f.trim());
const filesToProcessMobile = fs.readFileSync('batch2_files_mobile.txt', 'utf8').split('\n').filter(f => f.trim());
const filesToProcessTablet = fs.readFileSync('batch2_files_tablet.txt', 'utf8').split('\n').filter(f => f.trim());
